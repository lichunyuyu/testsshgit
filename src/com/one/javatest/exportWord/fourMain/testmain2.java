...
public class testmain2 {
    ...
    public static void main(String[] args) throws IOException, TemplateException {
        ...
        //xml的模板路径*/*
        String xmlTemplate ="template/test222.xml";
        //设置docx的模板路径 和文件名
        ...
        String toFilePath = totempath+"test2c.docx";//     ..\SSH\src\com\one\javatest\exportWord\fourMain\test2.docx

        //填充完数据的临时xml
        //String xmlTemp = "d:\\temp.xml";
        String xmlTemp = totempath+"temp2c.xml";      //  ..\SSH\src\com\one\javatest\exportWord\fourMain\temp.xml
