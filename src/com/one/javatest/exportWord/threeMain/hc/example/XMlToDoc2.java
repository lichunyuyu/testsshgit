   ...
   public static void main(String[] args)  throws  Exception{
     ...
     */
     static  void makeWord() throws Exception{
        ...
        String fileDirectory = basePath+"template2/";
        /** 加载文件 **/
        ...
        //String outFilePath = basePath+"data.xml";
         ...
         String outFilePath = basePath+"upload/"+"data.doc";
...
//        Writer out = new BufferedWriter(new OutputStreamWriter(fos),10240);
        ...
        try {
            ZipInputStream zipInputStream = ZipUtils.wrapZipInputStream(new FileInputStream(new File(basePath+"template2/"+"test.zip")));
            ZipOutputStream zipOutputStream = ZipUtils.wrapZipOutputStream(new FileOutputStream(new File(basePath+"template2/"+"test.docx")));
            String itemname = "word/document.xml";
            ZipUtils.replaceItem(zipInputStream, zipOutputStream, itemname, new FileInputStream(new File(basePath+"template2/"+"test.xml")));
